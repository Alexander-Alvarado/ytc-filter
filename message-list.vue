<template>
  <div id="message-list">
    <div v-if="isPopout" class="toolbar py-2" hidden>
      <div>
    ...
    <div v-if="!isPopout" class="toolbar py-2">
      <div>
        <button type="button" class="sm-btn" title="Go to bottom" @click="goToBottom">
          <svg class="svg-icon" viewBox="0 0 20 20" width="18" height="18">
            <path
    ...
    <div id="ytc-messages" class="vc-content" :style="{ height: height }" ref="content">
      <div class="vc-message-item ytc-pointer" v-for="(msg, index) in messages" :key="msg.id" :id="'ytc' + msg.id" @click="msgOptions = msgOptions == null ? index : null">
        ...
        <span class="vc-author" :class="{ author: msg.moderator, owner: msg.owner }">
          ...
          <div class="vc-author-verified" v-if="msg.verified" hidden>
...
export default {
  ...
  methods: {
    ...
    deleteMessage(index) {
      this.$store.commit('removeMessage', { videoId: this.videoId, feedName: this.feedName, messageIndex: index })
